...
import {Button, Cost, CostPrice, Price, Rouble, Img, TextInfo, Varients, Total} from '../../Pizza/PizzaCompontent/PizzaBlock';
...
const DrinkInfo = styled.div`
    padding: 0 20px 20px;
`
const DrinksBlock = ({image, name, prices, varients, id}) => {
