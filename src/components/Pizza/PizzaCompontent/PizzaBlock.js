...
const PizzaBlock = ({image, name, varients, prices, newItem, hot, category, getItem}) => {
    ...
    return ( 
        <Block>
            ...
            <PizzaInfo>
                ...
                <Cost>
                    <Button onClick={() => getItem({image, name, price, newItem, hot, category, varient})}>Choose</Button>
                    <CostPrice>
                        <Price>
                            {price}
                        </Price>
